...
Implementation scope, source findings and unperformed verification are recorded in
[Offline recitation discovery](docs/offline-recitation-discovery.md).

### 🛠 Tech Stack
* **Framework:** Flutter (Dart)
* **Planned speech recognition:** [transcribe.cpp](https://github.com/handy-computer/transcribe.cpp), pinned to revision `585b98f7e66777d16f2da734ceedaa7398060fa7`; word checking, not automatic pronunciation or stress grading.
